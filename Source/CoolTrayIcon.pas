...
USES
  ...
  SysUtils, Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Menus, Vcl.Dialogs, Vcl.ExtCtrls, Vcl.ImgList,
  SimpleTimer;
...
begin
 Result := False;
 if InitIcon
 then Result := Shell_NotifyIcon(NIM_MODIFY, @IconData);
end;
